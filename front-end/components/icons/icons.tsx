...
export const WorkIconProjectPage: React.FC = () => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
        strokeWidth={1.5}
        stroke="currentColor"
        className="size-12 text-yellowDark mr-4"
    >
        <path
            strokeLinecap="round"
            strokeLinejoin="round"
...
export const UserSolidIcon: React.FC = () => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="currentColor"
...
export const WarnIcon: React.FC = () => (
    <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="size-12 text-yellowDark"
    >
        <path
            fillRule="evenodd"
...
export const SendCommentsIcon: React.FC = () => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
...
export const OwnerIcon: React.FC = () => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="currentColor"
...
export const BoxsIcon: React.FC = () => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="currentColor"
